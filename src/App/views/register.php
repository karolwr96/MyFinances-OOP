                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <div class="form-outline">
                                                <input type="text" value="" name="userName" id="form3Example1" class="form-control" />
                                        ...
                                        <div class="form-outline mb-2">
                                            <input type="email" value="" name="email" id="form3Example3" class="form-control" />
                                        ...
                                        <div class="form-check d-flex justify-content-center mb-4">
                                            <input class="form-check-input me-2" type="checkbox" name="regulations" id="form2Example33" />
