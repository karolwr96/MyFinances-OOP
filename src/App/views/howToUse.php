                            ...
                            <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                <h2 class="mb-4">Achieve your goal with us
                                    ...
                                    <div class="text-center mt-5">
                                        <img src="/assets/img/green-money.jpg" style="border-radius: 10px; width: 295px;" alt="orange wallet with money">
                                    </div>

                                    <div class="text-center mt-5">
                                        <img src="/assets/img/chart.jpg" style="border-radius: 10px; width: 295px;" alt="chart">
                                    </div>
